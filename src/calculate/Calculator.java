...
public class Calculator {
    void addition(int a, int b) {//no return type with two parameter
        System.out.println(a + b);//print statement
    }

    void subtraction(int a, int b) {//no return type with two parameter
        System.out.println(a - b);//print statement
    }

    void division(int a, int b) {//no return type with two parameter
        System.out.println(a / b);//print statement
    }

    void multiplication(int a, int b) {//no return type with two parameter
        System.out.println(a * b);//print statement
    }
